...
export class Game {
    ...
    /**
     * @param {any} map_data_js
     */
    constructor(map_data_js) {
        const ret = wasm.game_new(map_data_js);
     ...
     * @param {boolean} is_mouse_down
     */
    tick(mouse_dx, mouse_dy, is_mouse_down) {
        wasm.game_tick(this.__wbg_ptr, mouse_dx, mouse_dy, is_mouse_down);
    }
    /**
     * @returns {string}
     */
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('cursorarena_io_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
